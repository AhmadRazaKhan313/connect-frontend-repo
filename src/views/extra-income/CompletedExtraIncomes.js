...
function createData(data, id, sr, date, category, userId, mobile, amount, paymentMethod, tid, details) {
    return { data, id, sr, date, category, userId, mobile, amount, paymentMethod, tid, details };
}

export default function CompletedExtraIncomes() {
    ...
    useEffect(() => {
        setFilters(['date', 'category', 'userId', 'amount', 'paymentMethod', 'tid', 'details', 'mobile']);
    }, []);
    ...
    const getEntries = () => {
        setIsLoading(true);
        jwt.getAllCompletedExtraIncome({ startDate, endDate })
            .then((res) => {
                let rowsData = [];
                                                                ...
                                                                <Button
                                                                    ...
                                                                    onClick={() =>
                                                                        navigate('/dashboard/edit-extra-income', {
                                                                            state: { data: row?.data, action: 'edit' }
                                                                        })
                                                                    }
                                                                >
                                                                    Edit
